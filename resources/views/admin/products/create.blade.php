...
@section('content')
    <div>
        <h1 class="display-6">Создание товара</h1>
    </div>
    <hr>
    <div class="col-md-6">
        ...
        <form action="{{route('products.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" name="name" placeholder="товар №123" class="form-control" aria-label="Название категории" aria-describedby="inputGroup-sizing-default">
            </div>
            <div class="input-group mb-3">
